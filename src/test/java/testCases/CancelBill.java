...
public class CancelBill {
    ...
    private BillCancelpage billCancelpage;
    ...
    public void setup() {
        ...
        billCancelpage = new BillCancelpage(driver);
    ...
    public void termChangeTest() throws InterruptedException, IOException {
        ...
        billCancelpage.clickProbilNoField();
        billCancelpage.clickThreeDot();
        billCancelpage.searchProbil();
        billCancelpage.enterProbillNo("030724");
        billCancelpage.clickApply();
        billCancelpage.editButtonClick();
        billCancelpage.threeDotClick();
        billCancelpage.clickCanceloption();
        billCancelpage.clickYesButton();
